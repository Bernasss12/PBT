...
public class KingBlaze extends EntityMob
{
    ...
    public KingBlaze(World par1World)
    {
        super(par1World);
    ...
    {
        return PBTMod.blazedDiamond.itemID;
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        if (par1)
        {
            ...
            for (int k = 0; k < j; ++k)
            {
                this.dropItem(PBTMod.blazedDiamond.itemID, 1);
            }
        }
    }
    ...
    @SideOnly(Side.CLIENT)
    public static class RenderKingBlaze extends RenderLiving {
    	
    	public static final ResourceLocation blazeKing = new ResourceLocation(PBTMod.modid, "/textures/mobs/blazeKing.png");
    	
		public RenderKingBlaze(ModelBase par1ModelBase, float par2) {
